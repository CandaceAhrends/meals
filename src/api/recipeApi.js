...
import { map, switchMap,combineAll, concatMap, mergeMap } from "rxjs/operators";
...
export const recipeObservable$ = data=> from(ptest).pipe(
  map(res => res.results),
